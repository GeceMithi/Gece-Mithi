...
export const academicDataDownload = [
  {
    year: 1,
    semester: 1,
    courses: [
  ...
  },
  {
    ...
    courses: [
      ...
      },
      {
        ...
        outlineLink:
          "https://drive.usercontent.google.com/download?id=1jPB-1UIXxs20zzFSwn4lh2LtXzHPzbrJ&export=download&authuser=0&confirm=t&uuid=39361488-21ab-4823-adae-ee4079727f5f&at=APcXIO3PXybA5mndaqdK465U-RY0:1772262818945",
  ...
  },
  {
    ...
    courses: [
      ...
      },
      {
        ...
        notesLink: "https://drive.usercontent.google.com/download?id=1ZDcJc4sMZh1gUw4LfRrsoPejF2vZPtyt&export=download&authuser=0&confirm=t&uuid=0366843a-eca7-4707-802b-b8d6a47d744c&at=ALBwUgmrrnbaATJ4O5G6gmBf1CWI:1777900468638",
      ...
      },
      {
        ...
        notesLink: "https://drive.usercontent.google.com/download?id=10E0XSsPx9zIDLHEcJYNKrGIxgbntK_ET&export=download&authuser=0&confirm=t&uuid=cd580fb6-2228-445e-9511-5ff8c6b675f3&at=ALBwUgkoM5Mmi7Uo6aGjOekEQ1q4:1777900558229",
...
// Export notesData for notes component (same structure as academicDataDownload)
export const notesData = academicDataDownload;

// Navigation structure for sections
export const navigationSections = [
  {
    id: 'outlines',
    title: 'Course Outlines',
    description: 'Access official course outlines for B.Ed (Hons) subjects',
    path: '/outlines',
    icon: '📚',
    color: '#004d00',
    dataKey: 'academicDataDownload'
  },
  {
    id: 'notes',
    title: 'Academic Notes',
    description: 'Access lecture notes and supporting material',
    path: '/notes',
    icon: '📝',
    color: '#FFD700',
    dataKey: 'notesData'
  },
  {
    ...
    icon: '📄',
    color: '#004d00',
    dataKey: 'pastPapersData'
  },
  {
    id: 'portfolio',
    title: 'Portfolio Templates',
    description: 'Download portfolio templates for assessments',
    path: '/resources',
    icon: '📁',
    color: '#FFD700',
  ...
  },
  {
    ...
    description: 'Access teaching aids and assessment tools',
    path: '/resources',
    icon: '🛠️',
    color: '#004d00',
    dataKey: 'toolsData'
...
// Section mapping for easy data access
export const sectionDataMap = {
  outlines: academicDataDownload,
  notes: notesData,
...
export const getDataBySection = (section) => {
  return sectionDataMap[section] || [];
};

// Helper function to get section info
export const getSectionInfo = (sectionId) => {
  return navigationSections.find(section => section.id === sectionId);
};