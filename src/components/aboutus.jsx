...
const TeamCard = ({ person, showImage = false, className = "" }) => (
    <YellowBorderCard className={`flex flex-col items-center text-center ${className}`}>
        ...
        {/* Content */}
        <div className="p-3 w-full flex flex-col items-center grow justify-center">
            {showImage && (
        ...
        <div className="w-full lg:w-1/2 space-y-4">
            ...
            <SectionDropdown title="Faculty Members" icon="👨‍🏫" isOpen={activeSection === 'faculty'} onClick={() => toggleSection('faculty')}>
                {loading ? (
                    ...
                    <div className="text-center py-8">
                        <p className="text-gray-500">No faculty members found. Admin can add faculty through the Content Manager.</p>
                    </div>
                )}
            </SectionDropdown>
            ...
            <SectionDropdown title="Visiting Faculty" icon="🤝" isOpen={activeSection === 'visiting'} onClick={() => toggleSection('visiting')}>
                {loading ? (
                    ...
                    <div className="text-center py-8">
                        <p className="text-gray-500">No visiting faculty found. Admin can add visiting faculty through the Content Manager.</p>
                    </div>
                )}
            </SectionDropdown>
            ...
            <SectionDropdown title="Non-Teaching Staff" icon="🛠️" isOpen={activeSection === 'nonTeaching'} onClick={() => toggleSection('nonTeaching')}>
                {loading ? (
                    ...
                    <div className="text-center py-8">
                        <p className="text-gray-500">No non-teaching staff found. Admin can add staff through the Content Manager.</p>
                    </div>
                )}
            </SectionDropdown>
                ...
                {loading ? (
                    ...
                    <div className="space-y-8">
                        {Object.entries(
                            ...
                            // Sort batches by year - simple and reliable ascending order
                            const batchOrder = ['Batch 2k17', 'Batch 2k18', 'Batch 2k19', 'Batch 2020', 'Batch 2k21', 'Batch 2k22', 'Batch 2k23', 'Batch 2k24', 'Batch 2k25', 'Batch 2k26', 'Batch 2k27', 'Batch 2k28', 'Batch 2k29', 'Batch 2k30'];
                    ...
                    <div className="text-center py-8">
                        <p className="text-gray-500">No volunteer teachers found. Admin can add volunteer teachers through the Content Manager.</p>
                    </div>
                )}
            </SectionDropdown>
