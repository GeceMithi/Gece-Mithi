...
export const DownloadLink = ({ linkUrl, buttonText }) => {
    ...
    return (
        <a 
            ...
            className="flex items-center text-sm font-semibold px-3 py-1 bg-green-600 text-white border-2 border-yellow-400 rounded-full hover:bg-red-600 hover:border-red-400 transition duration-300 shadow-md hover:shadow-lg"
        >
