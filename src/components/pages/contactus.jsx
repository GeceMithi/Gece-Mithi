    ...
    const faqs = [
        {
            ...
            answer: "Admissions for ADE and B.Ed. (Hons) Elementary programs typically start in December. Please check the official notice board or contact the college administration for exact dates."
        },
        {
            id: 2,
            question: "What is the fee structure?",
            answer: "The fee structure is set by the Government of Sindh and is very affordable. Contact the college office at +92-331-3708015 during office hours for detailed fee information."
        },
        {
            id: 3,
            question: "What programs are offered?",
            answer: "GECE Mithi offers Associate Degree in Education (ADE) and B.Ed. (Hons) Elementary programs. We also provide PTC and CT refresher courses for professional development."
        },
        {
            id: 4,
            question: "What are the eligibility requirements?",
            answer: "For ADE: Intermediate (HSC) with minimum 45% marks. For B.Ed. (Hons): Bachelor's degree with minimum 45% marks.<br />Contact the college for detailed admission criteria."
        },
        {
            id: 5,
            question: "Is hostel facility available?",
            answer: "Currently, the college does not provide hostel facilities. However, affordable accommodation options are available in Mithi city near the college."
        },
        {
            id: 6,
            question: "What are the office hours?",
            answer: "College office operates from Monday to Saturday, 8:00 AM to 2:00 PM.<br />Sunday is closed. For urgent queries, you can contact us via WhatsApp."
        }
    ];
        ...
        <div className="content-entry-animation">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-[#ffd200] h-full">
                ...
                {/* Form (Right Side) */}
                <div className="lg:col-span-2 bg-white rounded-3xl shadow-xl p-8 border border-[#ffd200]">
                    ...
                    <form onSubmit={sendToWhatsApp} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full px-4 py-3 rounded-lg border border-[#ffd200] text-gray-900 focus:ring-2 focus:ring-[#004d00] outline-none transition" 
            ...
            <div className="w-full bg-white rounded-2xl shadow-xl border-4 border-[#FFD700] overflow-hidden mt-8">
                {/* Header */}
                <div className="bg-gradient-to-r from-[#004d00] to-[#006400] text-white p-6">
                    ...
                    <p className="text-yellow-300 text-sm font-medium text-center mt-2">Quick answers to common questions</p>
                </div>
                    ...
                    {faqs.map((faq) => (
                        <div key={faq.id} className="border border-gray-200 rounded-lg overflow-hidden">
                            ...
                            >
                                ...
                                <svg
                                    className={`w-5 h-5 text-[#004d00] transition-transform ${openFaq === faq.id ? 'rotate-180' : ''}`}
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
